<template>
    <form @submit.prevent="updateTeacher(teacher)">
        <!-- Name -->
        <div>
            <label for="name" class="block text-sm font-medium text-gray-700">
                Name
            </label>
            <input v-model="teacher.name" id="name" type="text"
        ...
        <div class="mt-4">
            ...
            <input v-model="teacher.password" id="password" type="password"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
            <!-- Validation Errors -->
            <div class="text-red-600 mt-1">
...
const { updateTeacher, validationErrors, processing, teacher, getTeacher } = useTeachers()
