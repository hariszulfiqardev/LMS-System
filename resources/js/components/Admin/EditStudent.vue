<template>
    <form @submit.prevent="updateStudent(student)">
        ...
        <div>
            ...
            <input v-model="student.name" id="name" type="text"
        ...
        <div class="mt-4">
            ...
            <input v-model="student.password" id="password" type="password"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
            <!-- Validation Errors -->
            <div class="text-red-600 mt-1">
...
const { updateStudent, validationErrors, processing, student, getStudent } = useStudents()
